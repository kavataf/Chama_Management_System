...
$(function () {
  ...
  calendar = new Calendar(document.getElementById("calendar"), {
    ...
    eventClick: function (info) {
      ...
      if (!!scheds[id]) {
        _details.find("#event_ref").text(scheds[id].event_ref);
        _details.find("#event_venue_name").text(scheds[id].event_venue_name);
        _details.find("#event_name").text(scheds[id].event_name);
        _details.find("#event_type").text(scheds[id].event_type);
        _details.find("#event_start_time").text(scheds[id].event_start_date);
        _details.find("#event_end_time").text(scheds[id].event_end_date);
        _details.find("#hosting_department").text(scheds[id].dep_name);
        _details
          .find("#event_expected_members_numbers")
          .text(scheds[id].event_expected_members_numbers);
        _details
          .find("#event_calibre_of_guests")
          .text(scheds[id].event_calibre_of_guests);
        _details.modal("show");
      } else {
