...
$fromName = 'County Information Centres';
$from = "cic@makueni.go.ke";
$to = $user_email;
$subject = "Welcome To County Information Centre System";
$message = ' 
    <!doctype html>
    <html lang="en-US">
                                    ...
                                    <table width="95%" border="0"  cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:0 35px;" align="center">
                                                ...
                                                <h5 style="color:#1e1e2d; font-weight:500; margin:0;font-size:39px;font-family:"Rubik",sans-serif;">
                                                ...
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;" align="justify">
                                                    ...
                                                    Welcome to Government of Makueni County Information Centres. 
                                                    Your account has been set up. You can now login to the ' . $user_access_level . ' portal using the following credentials:
                                                </p><br>
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;" align="justify">
                                                    <b> Login email: ' . $user_email . ' <br>
                                                        Login password: Makueni102  <br>
                                                    </b>  
                                                <br> 
                                                Kindly make sure you change your password after login.
                                                </p>
