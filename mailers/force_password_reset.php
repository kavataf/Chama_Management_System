                                        ...
                                        <tr>
                                            <td style="padding:0 35px;" align="center">
                                                ...
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;" align="justify">
                                                    Greetings, <br>
                                                    You recently requested to reset the password for your County Information Centre account.
                                                </p><br>
                                                <p style="color:#455056; font-size:25px;line-height:24px; margin:0;" align="justify">
                                                    Kindly login using this default password: <b>Makueni102</b> and reset your password.
                                                </p>
